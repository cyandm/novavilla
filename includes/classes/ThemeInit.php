...
class ThemeInit
{
	...
	public static function init()
	{
		...
		add_action('wp_head', [__CLASS__, 'themeInitScript'], 0);
	...
	public static function frontendEnqueueScripts()
	{
		...
		$bundle_css_file = THEME_ASSETS_DIR . $bundle_css_path;

		if (file_exists($bundle_css_file)) {
	...
	public static function themeInitScript()
	{
?>
		<script>
			(function() {
				const storageKey = "novavilla-theme";
