...
<a href="<?php echo esc_url($permalink); ?>" class="flex flex-col gap-3 rounded-3xl border border-cynBorder bg-cynBgItem backdrop-blur-2xl p-4 min-h-[102px] max-lg:min-h-[134px] hover:border-cynBorderHover transition-all duration-300">
	<?php if (!empty($title)) : ?>
